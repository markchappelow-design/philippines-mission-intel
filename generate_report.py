...
def add_map_plate(elements, title, image_path, caption, legend, styles):
    ...
    elements.append(Paragraph(f"<b>Caption:</b> {caption}", caption_style))
    elements.append(Spacer(1, 4))
    elements.append(Paragraph(f"<b>Legend:</b> {legend}", caption_style))
